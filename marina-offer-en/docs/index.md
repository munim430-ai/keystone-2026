...
<p class="center"><em>"Where global dreams begin"</em></p>

---

<img src="assets/marina.jpg" alt="Marina Mou" class="hero-photo">

<p class="hero-name">Marina Mou</p>
<p class="hero-title">Selected Branch Manager — Keystone Education, Narsingdi</p>

<p class="center">
**Date:** 18 July 2026 &nbsp;|&nbsp; **Joining Date:** 1 August 2026<br>
...
```mermaid
flowchart LR
    A["Thousands of students in Narsingdi<br/>want to study abroad"] --> B["But there is no dedicated<br/>study-abroad office here"]
    B --> C["Every student is forced<br/>to travel to Dhaka"]
    C --> D["Extra travel cost + Dhaka agency fees<br/>= ৳3,00,000 or more"]
    D --> E["Keystone opens its<br/>first Narsingdi branch"]
    E --> F["Marina becomes the trusted,<br/>local, expert guide"]

    style A fill:#E8F5E9,stroke:#2E7D32,color:#1a1a1a
    style B fill:#FBE9E7,stroke:#8B1A1A,color:#1a1a1a
    style C fill:#FBE9E7,stroke:#8B1A1A,color:#1a1a1a
    style D fill:#FBE9E7,stroke:#8B1A1A,color:#1a1a1a
...
```mermaid
xychart-beta
    title "Your Possible Monthly Income (BDT)"
    x-axis ["2 Students", "3 Students", "5 Students"]
    y-axis "Income in Taka" 0 --> 90000
    bar [41000, 54000, 82000]
```

Stop for a second. Read that last number again. <span class="big-number">৳82,000</span> — every single month.
...
```mermaid
flowchart TD
    A["College Student"] --> B["Branch Manager, Narsingdi"]
    B --> C["Senior / Regional Manager"]
    B --> D["Owner of Your Own Branch"]
    A --> E["Your Own Korea Journey"]
    E -.supports.-> B

    style A fill:#FFF8E1,stroke:#F9A825,color:#1a1a1a
    ...
    style E fill:#FBE9E7,stroke:#8B1A1A,color:#1a1a1a
```
...
<p class="center"><em>"Where global dreams begin"</em><br>— The Keystone Education motto</p>
...
```mermaid
timeline
    title Your 11-Day Onboarding Journey
    Day 1–2 : Getting to know each other : Hear the Keystone story : Learn about Korea
    Day 3–4 : Understanding the market : What Narsingdi students want and fear
    Day 5–6 : First conversations : How to talk to a student : How to build trust
    Day 7–8 : Meeting Keystone : Our office : Our tools : Our process
    Day 9–10 : Getting ready : Your first-day plan : Your first-week goals
    Day 11 : Celebration : Tea and hope : You are ready
```

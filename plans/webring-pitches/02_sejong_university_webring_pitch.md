# WeBring Partnership Proposal
## 세종대학교 (Sejong University)
**Prepared by:** Jo Mi-young (조미영), CEO, WeBring (WICA Corporation)
**Date:** July 2026
**Rank in WeBring's priority list:** #2 (based on BD market demand intelligence)
...
| **Location** | Seoul |
| **Type** | Private |
| **IEQAS Certification** | Excellent |
| **Visa Type** | D-2 (regional for IT majors) |
| **Min. Language Score** | IELTS 6.5+ |
| **Scholarship Available** | 30% (IELTS 5.5+), 50% (IELTS 6.5+), 80% (IELTS 8.0+) |
| **Dormitory** | Yes |
| **Est. Int'l Students** | ~3,000+ |
...
> *Note: WeBring is aware that Sejong University currently works with WeCare Education for its Bangladesh pipeline. We respect existing relationships and propose this as a complementary, multi-region aggregation layer — not a replacement.*
...
WeBring will deliver the following to every international student admitted to Sejong University:
...
1. **15-minute intro call** with Sejong University International Office
...
**International Office Contact for Sejong University:**
📧 iab@sejong.ac.kr
📞 +82-2-3408-3118
🌐 https://oia.sejong.ac.kr

---

*This proposal was prepared as part of WeBring's 2026 Pan-Asia University Partnership Program.
WeBring serves students from Vietnam, India, Bangladesh, Nepal, Philippines, and Southeast Asia.*
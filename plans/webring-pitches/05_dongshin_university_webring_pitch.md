...
**Date:** July 2026
**Rank in WeBring's priority list:** #5 (based on BD market demand intelligence)
...
## 2. Why Dongshin University?

**University Profile:**
| Item | Detail |
|------|--------|
| **Location** | Naju (Jeonnam) |
| **Type** | Private |
| **IEQAS Certification** | Standard-4yr |
| **Visa Type** | D-2 |
| **Min. Language Score** | IELTS 5.5+ |
| **Scholarship Available** | 30–70% ladder (IELTS 5.5→30%, 8.0→70%) |
| **Dormitory** | Yes |
| **Est. Int'l Students** | ~800+ |
...
> *Note: WeBring is aware that Dongshin University currently works with WeCare Education for its Bangladesh pipeline. We respect existing relationships and propose this as a complementary, multi-region aggregation layer — not a replacement.*
...
WeBring will deliver the following to every international student admitted to Dongshin University:
...
1. **15-minute intro call** with Dongshin University International Office
...
**International Office Contact for Dongshin University:**
📧 global@dsu.ac.kr
📞 +82-61-330-3114
🌐 https://www.dsu.ac.kr
